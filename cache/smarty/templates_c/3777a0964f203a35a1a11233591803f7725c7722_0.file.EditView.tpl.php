...
function content_692846a33ba557_62841870 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php echo '<script'; ?>
 type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'varchar', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_NAME','module'=>'Vehicle','for_js'=>true),$_smarty_tpl);?>
' );
