...
{/if}
<input type='text' name='{$fields.color.name}'
id='{$fields.color.name}' size='30'
...
{/literal}{literal}
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='Vehicle' for_js=true}{literal}' );
